...
type University struct {
	...
	ProfileCompletenessScore     *int       `json:"profile_completeness_score,omitempty"`
	CostTier                     *string    `json:"cost_tier,omitempty"`
	AdmissionCompetitivenessTier *string    `json:"admission_competitiveness_tier,omitempty"`
	CountryPriorityGroup         *string    `json:"country_priority_group,omitempty"`
